    ...
    <div className="min-h-screen bg-background">
            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-border">
              ...
              <ul className="space-y-2">
                {electricalList.map((item, idx) => (
                  <li key={idx} className="text-xs font-semibold text-slate-650 flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {commNetworks.map((net, idx) => (
              <div key={idx} className="bg-slate-50 p-6 rounded-2xl border border-border text-center">
                <span className="font-semibold text-slate-800 text-sm">{net}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-4 bg-slate-900 text-white text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 tracking-tight">Connect Your Systems Seamlessly</h2>
