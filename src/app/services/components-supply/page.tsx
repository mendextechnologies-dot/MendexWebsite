    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((cat, idx) => (
              <div key={idx} className="bg-card p-8 sm:p-10 rounded-[2rem] border border-border shadow-sm">
      ...
      <section className="py-24 px-4 bg-secondary/20 border-t border-border text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 tracking-tight text-slate-900">Need a Sourcing Partner?</h2>
