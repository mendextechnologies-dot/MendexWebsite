    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-24 px-4 bg-white border-y border-border">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-5xl font-extrabold text-slate-900 mb-4 tracking-tight">Comprehensive Product Portfolio</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((cat, idx) => (
              <div key={idx} className="bg-slate-50 p-8 sm:p-10 rounded-[2rem] border border-border">
                <h3 className="text-xl font-bold text-slate-900 mb-6 border-b border-border pb-3">{cat.title}</h3>
                <ul className="space-y-2">
                  {cat.items.map((item, i) => (
                    <li key={i} className="text-xs font-semibold text-slate-650 flex items-center gap-2">
      ...
      <section className="py-24 px-4 bg-background border-t border-border">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-6 tracking-tight">Engineering-Based Product Selection</h2>
          <p className="text-slate-550 leading-relaxed text-base max-w-2xl mx-auto">
      ...
      <section className="py-24 px-4 bg-slate-900 text-white text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-6 tracking-tight">Need a Sourcing Partner?</h2>
