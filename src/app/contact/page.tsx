...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        title: "Message Sent",
        description: "We've received your inquiry and our engineering specialists will get back to you shortly.",
      });
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-6">
                  <div className="w-12 h-12 rounded-2xl bg-secondary flex items-center justify-center text-accent border border-border">
